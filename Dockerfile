...
ENV DCM4CHE_VERSION="dcm4chee-arc-$DCM4CHEE_ARC_VERSION-mysql-secure"
...
RUN curl -O -L https://github.com/opendicom/dcm4chee-arc-light-releases/releases/download/$DCM4CHEE_ARC_VERSION/$DCM4CHE_VERSION.zip \
    ...
    && mv deploy/dcm4chee-arc-ear-$DCM4CHEE_ARC_VERSION-mysql-secure.ear /docker-entrypoint.d/deployments/
